...
<head>
  ...
  <title>Psiqui | Atendimento </title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <nav class="nav-item">
          <a href="{{ route('panel.psychologist') }}" class="nav-link">
         ...
         <!-- <li class="nav-item">
              <a href="carteira.html" class="nav-link">
          ...
          <table class="table table-striped projects">
              ...
              <tbody>
                  <tr>
                      ...
                      <td>
                          <a>
                              Psicólogo(a) - Valéria Ribeiro
                          </a>
                          <br/>
                          <small>
                              Data da Seção - 10/11/2021
                              <p>Horario da seção - 10:00 am
                      ...
                      <td>
                          <ul class="list-inline">
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="../../dist/img/user8-128x128.jpg">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="../../dist/img/valeria.jpeg">
                              </li>
                      ...
                      <td class="project_progress">
                          ...
                          <small>
                              Falta 00 dia e 00:00 hrs para sua sessão começar
                          </small>
                      </td>
                      ...
                      <td class="project-actions text-right">
                          <a class="btn btn-primary btn-sm" href="perfil psicologo.html">
                              <i class="fas fa-user">
                              </i>
                              Perfil do Psicologo
                          </a>
                          <a class="btn btn-info btn-sm" href="zoom/email/PHPMailer-master/examples/gmail.php">
                              <i class="fas fa-screen">
                              </i>
                              Video Chamada
                          </a>
                   ...
                   <tr>
                      ...
                      <td>
                          <a>
                              Psicólogo(a) - Gabriella Jeremias Soares
                          </a>
                          <br/>
                          <small>
                              Data da Seção - 11/11/2021
                              <p>Horario da seção - 10:00 am
                      ...
                      <td>
                          <ul class="list-inline">
                              ...
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="../../dist/img/gabriella.jpeg">
                              </li>
                      ...
                      <td class="project_progress">
                          <div class="progress progress-sm">
                              <div class="progress-bar bg-green" role="progressbar" aria-valuenow="57" aria-valuemin="0" aria-valuemax="80" style="width: 80%">
                              </div>
                          </div>
                          <small>
                                   Falta 5 dia e 05:20 hrs para sua sessão começar
                          </small>
                      </td>
                      <td class="project-state">
                          <span class="badge badge-success">Aprovado</span>
                   ...
                   <tr>
                      ...
                      <td>
                          <a>
                              Psicólogo(a) - Lucas Diniz Batista
                          </a>
                          <br/>
                          <small>
                              Data da Seção - 13/11/2021
                              <p>Horario da seção - 10:00 am
                      ...
                      <td>
                          <ul class="list-inline">
                              ...
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="../../dist/img/lucas.jpg">
                              </li>
                      ...
                      <td class="project_progress">
                          <div class="progress progress-sm">
                              <div class="progress-bar bg-green" role="progressbar" aria-valuenow="57" aria-valuemin="0" aria-valuemax="60" style="width: 60%">
                              </div>
                          </div>
                          <small>
                                   Falta 00 dia e 00:00 hrs para sua sessão começar
                   ...
                   <tr>
                      ...
                      <td class="project_progress">
                          <div class="progress progress-sm">
                              <div class="progress-bar bg-green" role="progressbar" aria-valuenow="57" aria-valuemin="0" aria-valuemax="10" style="width: 10%">
                              </div>
                          </div>
                          <small>
                                   Falta 00 dia e 00:00 hrs para sua sessão começar
