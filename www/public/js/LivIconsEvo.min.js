...
a.defaultRepeatDelay=b.defaultRepeatDelay;return a}return H}});k(document).ready(function(){k(".livicon-evo").addLiviconEvo()});k(window).on("orientationchange",function(){k(window).resize()});L.counter=1});